        ...
        <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
          <ul class="pb-2 space-y-2">
            <li>
              <NuxtLink to="/admin" :class="route.name == 'admin' ? 'bg-gray-100' : ''"
                ...
                <span class="ml-3" sidebar-toggle-item>首页</span>
              </NuxtLink>
            </li>
            <li>
              ...
              <div v-show="openlist == 'crud'">
                <ul class="space-y-2 py-2">
                  <li>
                    <NuxtLink to="/admin/goods" :class="route.name == 'admin-products' ? 'bg-gray-100 ' : ''"
          ...
          <div class="pt-2 space-y-2">
            <a href="https://github.com/themesberg/flowbite-admin-dashboard/issues" target="_blank"
              ...
              <span class="ml-3" sidebar-toggle-item>支持一下</span>
            </a>
          </div>
        </div>
      </div>
